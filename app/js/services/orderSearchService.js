four51.app.factory('OrderSearch', ['$resource', '$451', function($resource, $451) {
    ...
    var _search = function(stat, success) {
	    typeof stat.DateRangeFrom != 'string' ? stat.DateRangeFrom = stat.DateRangeFrom.toISOString() : null;
	    typeof stat.DateRangeTo != 'string' ? stat.DateRangeTo = stat.DateRangeTo.toISOString() : null;
