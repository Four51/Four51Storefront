four51.app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
	...
	$routeProvider.
		...
		when('/cart/:productInteropID/:lineItemIndex', { templateUrl: 'productDetailTemplate.html', controller: 'LineItemEditCtrl'}).
		when('/cart/:productInteropID/:orderID/:lineItemIndex', { templateUrl: 'productDetailTemplate.html', controller: 'LineItemEditCtrl'}).
